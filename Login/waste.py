...
st.text(
    "this app proposes to transport waste to those who require it for useful purposes.")
...
st.text(
    "Paper, Plastic, Organic, Glass, Metal. The users can submit waste that")
st.text(
    "2)The delivery of the waste from the user to the company where the latter can order")
st.text(
    "the waste materials they want to use/process, right to their doorstep.")

st.text(
    "3)Utilisation of Waste : The company now, uses the waste by amicably collecting it,")
